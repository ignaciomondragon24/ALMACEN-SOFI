...
# ─── Diseños pre-armados lindos para cada tipo y tamaño ───
...
DEFAULT_LAYOUTS = {
    'simple_50x40': {
        ...
        'layout': {
            ...
            'border_width': 0.4,
            'elements': [
                {'id': 'e1', 'type': 'shape', 'x': 0, 'y': 0, 'width': 50, 'height': 1.2,
                 'backgroundColor': '#E91E8C', 'borderWidth': 0, 'borderRadius': 0, 'zIndex': 2},
                {'id': 'e2', 'type': 'variable', 'variable': 'nombre_producto',
                 'x': 2, 'y': 2, 'width': 46, 'height': 13,
                ...
                {'id': 'e4', 'type': 'line', 'x': 5, 'y': 19, 'width': 40, 'height': 0.3,
                 'lineColor': '#E91E8C', 'lineWidth': 0.3, 'lineStyle': 'solid', 'zIndex': 5},
                {'id': 'e5', 'type': 'variable', 'variable': 'precio_unitario',
                 'x': 3, 'y': 20, 'width': 44, 'height': 17,
    ...
    'bulk_100x70': {
        ...
        'layout': {
            ...
            'border_width': 0.5,
            'elements': [
                {'id': 'e1', 'type': 'shape', 'x': 0, 'y': 0, 'width': 100, 'height': 2,
                 'backgroundColor': '#F5D000', 'borderWidth': 0, 'borderRadius': 0, 'zIndex': 2},
                {'id': 'e2', 'type': 'variable', 'variable': 'nombre_producto',
                 'x': 4, 'y': 4, 'width': 92, 'height': 16,
                 'fontFamily': 'Arial Black', 'fontSize': 16, 'fontWeight': 'bold',
                 'color': '#000000', 'backgroundColor': 'transparent',
                 'textAlign': 'center', 'verticalAlign': 'middle',
                 'autoScale': True, 'minFontSize': 9, 'zIndex': 10},
                ...
                {'id': 'e4', 'type': 'shape', 'x': 15, 'y': 52, 'width': 70, 'height': 14,
                 'backgroundColor': '#F5D000', 'borderColor': 'transparent',
                 'borderWidth': 0, 'borderRadius': 3, 'zIndex': 5},
                {'id': 'e5', 'type': 'variable', 'variable': 'tipo_empaque',
                 'x': 17, 'y': 53, 'width': 28, 'height': 12,
                 'fontFamily': 'Arial Black', 'fontSize': 12, 'fontWeight': 'bold',
                 'color': '#2D1E5F', 'backgroundColor': 'transparent',
                 'textAlign': 'right', 'verticalAlign': 'middle',
                 'autoScale': True, 'minFontSize': 8, 'zIndex': 10},
                {'id': 'e6', 'type': 'variable', 'variable': 'contenido_empaque',
                 'x': 48, 'y': 53, 'width': 35, 'height': 12,
                 'fontFamily': 'Arial Black', 'fontSize': 12, 'fontWeight': 'bold',
                 'color': '#2D1E5F', 'backgroundColor': 'transparent',
    ...
    'bulk_140x100': {
        ...
        'layout': {
            ...
            'border_width': 0.6,
            'elements': [
                {'id': 'e1', 'type': 'shape', 'x': 0, 'y': 0, 'width': 140, 'height': 3,
                 'backgroundColor': '#F5D000', 'borderWidth': 0, 'borderRadius': 0, 'zIndex': 2},
                {'id': 'e2', 'type': 'variable', 'variable': 'nombre_producto',
                 'x': 6, 'y': 6, 'width': 128, 'height': 22,
                 'fontFamily': 'Arial Black', 'fontSize': 22, 'fontWeight': 'bold',
                 'color': '#000000', 'backgroundColor': 'transparent',
                 'textAlign': 'center', 'verticalAlign': 'middle',
                 'autoScale': True, 'minFontSize': 12, 'zIndex': 10},
                {'id': 'e3', 'type': 'variable', 'variable': 'precio_total',
                 'x': 10, 'y': 32, 'width': 120, 'height': 36,
                 'fontFamily': 'Impact', 'fontSize': 52, 'fontWeight': 'bold',
                 'color': '#E91E8C', 'backgroundColor': 'transparent',
                 'textAlign': 'center', 'verticalAlign': 'middle',
                 'autoScale': True, 'minFontSize': 22, 'zIndex': 10},
                {'id': 'e4', 'type': 'shape', 'x': 20, 'y': 74, 'width': 100, 'height': 20,
                 'backgroundColor': '#F5D000', 'borderColor': 'transparent',
                 'borderWidth': 0, 'borderRadius': 4, 'zIndex': 5},
                {'id': 'e5', 'type': 'variable', 'variable': 'tipo_empaque',
                 'x': 24, 'y': 76, 'width': 40, 'height': 16,
                 'fontFamily': 'Arial Black', 'fontSize': 16, 'fontWeight': 'bold',
                 'color': '#2D1E5F', 'backgroundColor': 'transparent',
                 'textAlign': 'right', 'verticalAlign': 'middle',
                 'autoScale': True, 'minFontSize': 10, 'zIndex': 10},
                {'id': 'e6', 'type': 'variable', 'variable': 'contenido_empaque',
                 'x': 68, 'y': 76, 'width': 48, 'height': 16,
                 'fontFamily': 'Arial Black', 'fontSize': 16, 'fontWeight': 'bold',
                 'color': '#2D1E5F', 'backgroundColor': 'transparent',
                 'textAlign': 'left', 'verticalAlign': 'middle',
                 'autoScale': True, 'minFontSize': 10, 'zIndex': 10},
    ...
    'weight_100x70': {
        ...
        'layout': {
            ...
            'elements': [
                {'id': 'e1', 'type': 'shape', 'x': 0, 'y': 0, 'width': 100, 'height': 2,
                 'backgroundColor': '#28a745', 'borderWidth': 0, 'borderRadius': 0, 'zIndex': 2},
                {'id': 'e2', 'type': 'variable', 'variable': 'nombre_producto',
                 'x': 4, 'y': 4, 'width': 92, 'height': 14,
                 'fontFamily': 'Arial Black', 'fontSize': 14, 'fontWeight': 'bold',
                 'color': '#000000', 'backgroundColor': 'transparent',
                 'textAlign': 'center', 'verticalAlign': 'middle',
                 'autoScale': True, 'minFontSize': 8, 'zIndex': 10},
                {'id': 'e3', 'type': 'line', 'x': 5, 'y': 19, 'width': 90, 'height': 0.3,
                 'lineColor': '#28a745', 'lineWidth': 0.3, 'lineStyle': 'solid', 'zIndex': 5},
                {'id': 'e4', 'type': 'text', 'content': '100 GR',
                 'x': 2, 'y': 21, 'width': 30, 'height': 7,
                ...
                {'id': 'e5', 'type': 'variable', 'variable': 'precio_100g',
                 'x': 2, 'y': 28, 'width': 30, 'height': 14,
                 'fontFamily': 'Arial Black', 'fontSize': 16, 'fontWeight': 'bold',
                 'color': '#E91E8C', 'backgroundColor': 'transparent',
                 'textAlign': 'center', 'verticalAlign': 'middle',
                 'autoScale': True, 'minFontSize': 8, 'zIndex': 10},
                {'id': 'e6', 'type': 'text', 'content': '¼ Kg',
                 'x': 35, 'y': 21, 'width': 30, 'height': 7,
                 'fontFamily': 'Arial', 'fontSize': 8, 'fontWeight': 'bold',
                 'color': '#666666', 'backgroundColor': 'transparent',
                 'textAlign': 'center', 'verticalAlign': 'middle',
                 'autoScale': False, 'zIndex': 10},
                {'id': 'e7', 'type': 'variable', 'variable': 'precio_250g',
                 ...
                 'textAlign': 'center', 'verticalAlign': 'middle',
                 'autoScale': True, 'minFontSize': 8, 'zIndex': 10},
                {'id': 'e8', 'type': 'shape', 'x': 66, 'y': 20, 'width': 32, 'height': 24,
                 'backgroundColor': 'rgba(40,167,69,0.08)', 'borderColor': '#28a745',
                 'borderWidth': 0.3, 'borderRadius': 2, 'zIndex': 3},
                {'id': 'e9', 'type': 'text', 'content': 'Kg',
                 'x': 68, 'y': 21, 'width': 28, 'height': 7,
                 'fontFamily': 'Arial', 'fontSize': 8, 'fontWeight': 'bold',
                 'color': '#28a745', 'backgroundColor': 'transparent',
                 'textAlign': 'center', 'verticalAlign': 'middle',
                 'autoScale': False, 'zIndex': 10},
                {'id': 'e10', 'type': 'variable', 'variable': 'precio_1kg',
                 'x': 68, 'y': 28, 'width': 28, 'height': 14,
                 'fontFamily': 'Impact', 'fontSize': 20, 'fontWeight': 'bold',
                 'color': '#E91E8C', 'backgroundColor': 'transparent',
                 'textAlign': 'center', 'verticalAlign': 'middle',
                 'autoScale': True, 'minFontSize': 10, 'zIndex': 10},
                {'id': 'e11', 'type': 'line', 'x': 5, 'y': 46, 'width': 90, 'height': 0.3,
                 'lineColor': '#ddd', 'lineWidth': 0.2, 'lineStyle': 'solid', 'zIndex': 5},
        ...
        'layout': {
            ...
            'elements': [
                {'id': 'e1', 'type': 'shape', 'x': 0, 'y': 0, 'width': 140, 'height': 3,
                 'backgroundColor': '#28a745', 'borderWidth': 0, 'borderRadius': 0, 'zIndex': 2},
                {'id': 'e2', 'type': 'variable', 'variable': 'nombre_producto',
                 'x': 6, 'y': 6, 'width': 128, 'height': 20,
                 'fontFamily': 'Arial Black', 'fontSize': 20, 'fontWeight': 'bold',
                 'color': '#000000', 'backgroundColor': 'transparent',
                 'textAlign': 'center', 'verticalAlign': 'middle',
                 'autoScale': True, 'minFontSize': 11, 'zIndex': 10},
                {'id': 'e3', 'type': 'line', 'x': 8, 'y': 28, 'width': 124, 'height': 0.4,
                 'lineColor': '#28a745', 'lineWidth': 0.4, 'lineStyle': 'solid', 'zIndex': 5},
                {'id': 'e4', 'type': 'text', 'content': '100 GR',
                 'x': 3, 'y': 31, 'width': 42, 'height': 10,
                 'fontFamily': 'Arial', 'fontSize': 11, 'fontWeight': 'bold',
                 'color': '#666666', 'backgroundColor': 'transparent',
                 'textAlign': 'center', 'verticalAlign': 'middle',
                 'autoScale': False, 'zIndex': 10},
                {'id': 'e5', 'type': 'variable', 'variable': 'precio_100g',
                 'x': 3, 'y': 41, 'width': 42, 'height': 20,
                 'fontFamily': 'Arial Black', 'fontSize': 22, 'fontWeight': 'bold',
                 'color': '#E91E8C', 'backgroundColor': 'transparent',
                 'textAlign': 'center', 'verticalAlign': 'middle',
                 'autoScale': True, 'minFontSize': 12, 'zIndex': 10},
                {'id': 'e6', 'type': 'text', 'content': '¼ Kg',
                 'x': 49, 'y': 31, 'width': 42, 'height': 10,
                 'fontFamily': 'Arial', 'fontSize': 11, 'fontWeight': 'bold',
                 'color': '#666666', 'backgroundColor': 'transparent',
                 'textAlign': 'center', 'verticalAlign': 'middle',
                 'autoScale': False, 'zIndex': 10},
                {'id': 'e7', 'type': 'variable', 'variable': 'precio_250g',
                 'x': 49, 'y': 41, 'width': 42, 'height': 20,
                 'fontFamily': 'Arial Black', 'fontSize': 22, 'fontWeight': 'bold',
                 'color': '#E91E8C', 'backgroundColor': 'transparent',
                 'textAlign': 'center', 'verticalAlign': 'middle',
                 'autoScale': True, 'minFontSize': 12, 'zIndex': 10},
                {'id': 'e8', 'type': 'shape', 'x': 94, 'y': 30, 'width': 43, 'height': 34,
                 'backgroundColor': 'rgba(40,167,69,0.08)', 'borderColor': '#28a745',
                 'borderWidth': 0.3, 'borderRadius': 3, 'zIndex': 3},
                {'id': 'e9', 'type': 'text', 'content': 'Kg',
                 'x': 96, 'y': 31, 'width': 39, 'height': 10,
                 'fontFamily': 'Arial', 'fontSize': 11, 'fontWeight': 'bold',
                 'color': '#28a745', 'backgroundColor': 'transparent',
                 'textAlign': 'center', 'verticalAlign': 'middle',
                 'autoScale': False, 'zIndex': 10},
                {'id': 'e10', 'type': 'variable', 'variable': 'precio_1kg',
                 'x': 96, 'y': 41, 'width': 39, 'height': 20,
                 'fontFamily': 'Impact', 'fontSize': 28, 'fontWeight': 'bold',
                 'color': '#E91E8C', 'backgroundColor': 'transparent',
                 'textAlign': 'center', 'verticalAlign': 'middle',
                 'autoScale': True, 'minFontSize': 14, 'zIndex': 10},
                {'id': 'e11', 'type': 'line', 'x': 8, 'y': 68, 'width': 124, 'height': 0.3,
                 'lineColor': '#ddd', 'lineWidth': 0.2, 'lineStyle': 'solid', 'zIndex': 5},
                {'id': 'e12', 'type': 'text', 'content': 'VENTA AL PESO',
                 'x': 30, 'y': 72, 'width': 80, 'height': 22,
                 'fontFamily': 'Arial', 'fontSize': 11, 'fontWeight': 'bold',
                 'color': '#28a745', 'backgroundColor': 'transparent',
                 'textAlign': 'center', 'verticalAlign': 'middle',
                 'autoScale': False, 'zIndex': 10},
