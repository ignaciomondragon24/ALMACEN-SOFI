/* Lo de Josefina - POS Main JavaScript (Updated) */
    ...
    function showBulkQuantityModal(product) {
        ...
        const modalHtml = `
            <div class="modal fade" id="bulkQuantityModal" tabindex="-1">
                <div class="modal-dialog modal-sm">
                    <div class="modal-content bg-dark text-white" style="border:1.5px solid rgba(195, 50, 135,0.25);border-radius:14px;">
                        <div class="modal-header border-0 pb-1">
                            <div>
                                <h5 class="modal-title mb-0">
                                    <i class="fas fa-candy-cane me-2" style="color:#C33287;"></i>${product.name}
                                </h5>
        ...
        function updatePreview() {
            ...
            if (isGranel && stockGrams > 0 && qty > stockGrams) {
                ...
                confirmBtn.title = '';
                input.style.borderColor = 'rgba(195, 50, 135,0.3)';
            }
        }
        ...
        function showMpQrModal(amount) {
            ...
            modal.innerHTML = `
                <div style="background:#fff;padding:40px 50px;border-radius:24px;text-align:center;max-width:480px;box-shadow:0 20px 60px rgba(0,0,0,0.5);">
                    ...
                    <div style="background:#fff8e1;border:2px dashed #F5D050;border-radius:14px;padding:18px;margin-bottom:20px;">
                        <div style="font-size:1.05rem;color:#333;font-weight:600;margin-bottom:6px;">
                            <i class="fas fa-hand-point-right me-2" style="color:#C33287;"></i>Pedile al cliente que escanee el QR pegado en la caja
                        </div>
